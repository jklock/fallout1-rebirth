...
2. Run:
   - `scripts/patch/rebirth_patch_app.sh --base <game-data> --out <patched>`
...
2. Run:
   - `scripts/patch/rebirth_patch_ipa.sh --base <game-data> --out <patched>`
...
### 1) `scripts/patch/rebirth_patch_data.sh` (core)
Inputs:

---
name: fallout-ce-rebirth
description: Build, test, and develop the Fallout CE Rebirth project - an Apple-only fork (macOS/iOS/iPadOS) of Fallout 1 Community Edition. Use this skill for building the game, running iOS simulator tests, understanding the C++ game engine architecture, and following project conventions.
---

# Fallout CE Rebirth Development Skill

## Overview
This skill provides guidance for working with the Fallout CE Rebirth project, an Apple-only fork of Fallout 1 Community Edition targeting macOS and iPad/iOS.

...
#   RELEASE_VERSION=V2 ./scripts/build-releases.sh
#
...
"$ROOT_DIR/scripts/test-ios-simulator.sh" --shutdown >/dev/null 2>&1 || true

# Clean build artifacts
"$ROOT_DIR/scripts/dev-clean.sh"
...
"$ROOT_DIR/scripts/dev-verify.sh"
"$ROOT_DIR/scripts/test-macos.sh"
"$ROOT_DIR/scripts/test-ios-headless.sh" --build

log_section "Building release artifacts"
export BUILD_TYPE

# iOS IPA
"$ROOT_DIR/scripts/build-ios-ipa.sh"
